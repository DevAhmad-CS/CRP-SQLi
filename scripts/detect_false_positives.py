...
suspicious_sample[['Query', 'Label']].to_csv('suspicious_queries_for_review.csv', index=False)
print(f"\n📝 تم حفظ {len(suspicious_sample)} استعلام مشبوه في: suspicious_queries_for_review.csv")
