...
val_df.to_csv('dataset/validation_final.csv', index=False)
test_df.to_csv('dataset/test_final.csv', index=False)

print(f"\n✅ تم حفظ الأقسام في:")
print(f"   - dataset/train_final.csv")
print(f"   - dataset/validation_final.csv")
print(f"   - dataset/test_final.csv")
